...
class Page extends MY_Controller
{
	...
	public function main($id)
	{
		...
		if ($id == "create") {
			...
			// Create
			$this->load->view("v1/main/create");
		} else if ($id == "update") {

			$this->load->view("v1/sub_main/update");
		} else {
			...
			$this->load->view("v1/main/sub_list", $data);
			$this->load->view("base/v1/footer");
		}
	}
	...
	public function sub($main, $sub)
	{
		...
		if ($sub == "create") {
			...
			$this->load->view("v1/sub_main/create", $data);
			...
			$this->load->view("v1/sub_main/read", $data);
			$this->load->view("base/v1/footer");
		}
	}
	...
	public function main_update($main)
	{
		...
		$this->load->view("v1/main/update", $data);
	}
	...
	public function sub_update($main, $sub)
	{
		...
		$this->load->view("v1/sub_main/update", $data);
	}
}
