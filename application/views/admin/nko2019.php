  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Nilai Kinerja Organisasi 2019</h1>
          </div>
          <div class="col-sm-6">
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-6 col-md-3 mb-4 text-center">
            ...
            <div class="knob-label">Realisasi : 90%</div>
          </div>
          <!-- ./col -->
          <div class="col-6 col-md-3 mb-4 text-center">
            ...
            <div class="knob-label">Target : 75%</div>
            <div class="knob-label">Realisasi : 98.2%</div>
          </div>
          <!-- ./col -->
          <div class="col-6 col-md-3 mb-4 text-center">
            ...
            <div class="knob-label">Target : 4.38</div>
            <div class="knob-label">Realisasi : 4.6</div>
          </div>
          <!-- ./col -->
          <div class="col-6 col-md-3 mb-4 text-center">
            ...
            <div class="knob-label">Target : 90.3%</div>
          ...
          <div class="col-6 col-md-3 mb-4 text-center">
            ...
            <div class="knob-label">Target : 3</div>
            <div class="knob-label">Realisasi : 4</div>
          </div>
          <!-- ./col -->
          <div class="col-6 col-md-3 mb-4 text-center">
            ...
            <div class="knob-label">Target : 100%</div>
            <div class="knob-label">Realisasi : 117.38%</div>
          </div>
          <!-- ./col -->
          <div class="col-6 col-md-3 mb-4 text-center">
            ...
            <div class="knob-label">Target : 80%</div>
            <div class="knob-label">Realisasi : 88%</div>
          </div>
          <!-- ./col -->
          <div class="col-6 col-md-3 mb-4 text-center">
            ...
            <div class="knob-label">Target : 92.7%</div>
            <div class="knob-label">Realisasi : 100%</div>
          </div>
          <div class="col-6 col-md-3 mb-4 text-center">
            ...
            <div class="knob-label">Target : 85%</div>
            <div class="knob-label">Realisasi : 100%</div>
          </div>
          <!-- ./col -->
          <div class="col-6 col-md-3 mb-4 text-center">
          ...
          <div class="col-6 col-md-3 mb-4 text-center">
            ...
            <div class="knob-label">Target : 75%</div>
            <div class="knob-label">Realisasi : 92.23%</div>
          </div>
          <!-- ./col -->
          <div class="col-6 col-md-3 mb-4 text-center">
            ...
            <div class="knob-label">Target : 70%</div>
            <div class="knob-label">Realisasi : 88.47%</div>
          </div>
          <!-- ./col -->
          <!-- ./col -->
          <div class="col-6 col-md-3 mb-4 text-center">
            ...
            <div class="knob-label">Target : 90%</div>
            <div class="knob-label">Realisasi : 100%</div>
          </div>
          <!-- ./col -->
          <!-- ./col -->
          <div class="col-6 col-md-3 mb-4 text-center">
            ...
            <div class="knob-label">Target : 95%</div>
            <div class="knob-label">Realisasi : 95%</div>
          </div>
          <!-- ./col -->
        </div>
        <!-- /.row -->
